...
- commit: 세이브, 스테이지 영역의 화일들을 가지고 커및을 만들 수 있다.
- push: 원격 저장소에 커밋을 업로드한다.

## 파일의 내용 되돌리기

- 특정 화일의 내용을 마지막 커밋으로 돌리고 싶다면 해당 파일 선택 후 '코드뭉치 버리기' 선택 
...
- revert로 여러 커밋을 되돌리려면 최신부터 수ㄴ서대로 revert 하자
- 그렿게 하면 충돌을 막을 수 있다.
